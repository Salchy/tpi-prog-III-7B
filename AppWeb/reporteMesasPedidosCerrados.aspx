<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reporteMesasPedidosCerrados.aspx.cs" Inherits="AppWeb.reporteMesasPedidosCerrados" %>
    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            <div class="text-center">
                <h1>CANTIDAD DE PEDIDOS CERRADOS POR MESA HOY</h1>
            </div>
            <div class="row ">
