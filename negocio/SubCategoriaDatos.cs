...
namespace negocio
{
    public class SubCategoriaDatos
    {
        ...
        public List<SubCategoria> listarSubCategorias()
        {
            ...
            try
            {
                database.setQuery("SELECT s.idSubCategoria, s.nombreSubCategoria, s.idCategoriaPrincipal, s.Estado ,c.Nombre_Categoria FROM SubCategoriaMenu s INNER JOIN Categoria_Menu c ON s.idCategoriaPrincipal = c.id_Categoria");
                database.execQuery();
