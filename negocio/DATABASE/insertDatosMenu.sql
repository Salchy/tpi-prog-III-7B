...
INSERT INTO Menu(Nombre_Menu, idSubCategoria, Descripcion, Precio, Stock) VALUES
	-- Categoría 1: Entradas
		...
		('Picada Clásica', 1, 'Variedad de fiambres, quesos y pan', 5500.00, 12),
	...
	-- Categoría 2: Ensaladas
		...
		('Ensalada César', 4, 'Lechuga, croutons, queso y aderezo César', 2200.00, 8),
		('Ensalada Primavera', 4, 'Mix de hojas verdes con zanahoria rallada', 1800.00, 4),
		('Ensalada Mediterránea', 4, 'Tomate cherry, aceitunas y rúcula', 2000.00, 8),

		-- Subcategoría 5: Con proteínas
		('Ensalada con Pollo', 5, 'Lechuga, pollo grillado y huevo', 2400.00, 5),
		('Ensalada con Atún', 5, 'Hojas verdes, atún y choclo', 2300.00, 7),
	...
	-- Categoría 3: Platos principales
		...
		('Bife de Chorizo', 6, 'Bife de chorizo con papas rústicas', 4500.00, 15),
		('Milanesa con Papas', 6, 'Milanesa de carne con papas fritas', 4000.00, 10),
		('Lomo a la Pimienta', 6, 'Lomo con salsa a la pimienta y puré', 4700.00, 12),
		('Asado con Ensalada', 6, 'Tira de asado con ensalada mixta', 4600.00, 18),
		('Pollo a la Parrilla', 6, 'Pechuga grillada con guarnición', 3900.00, 6),

		-- Subcategoría 7: Pastas
		('Fideos con Tuco', 7, 'Fideos caseros con salsa de tomate', 3000.00, 12),
		('Ñoquis con Salsa', 7, 'Ñoquis de papa con salsa a elección', 3200.00, 15),
		...
		('Salmón con Guarnición', 8, 'Salmón grillado con vegetales', 5500.00, 0),
		('Lenguado al Limón', 8, 'Lenguado con salsa de limón', 5000.00, 2),
		('Trucha a las Finas Hierbas', 8, 'Trucha con manteca y hierbas', 5300.00, 3),

	-- Categoría 4: Menú infantil
		-- Subcategoría 9: Platos
		...
		('Salchichas con Puré', 9, 'Salchichas con puré de papa cremoso', 2200.00, 0),

		-- Subcategoría 10: Postres
		('Helado Simple', 10, '1 bocha de helado a elección', 1000.00, 11),
	...
	-- Categoría 5: Pastas caseras
		-- Subcategoría 11: Rellenas
		('Sorrentinos Jamón y Queso', 11, 'Sorrentinos caseros con salsa mixta', 3500.00, 6),
	...
	-- Categoría 6: Pescados y mariscos
		...
		('Salmón a la Parrilla', 13, 'Salmón fresco grillado con hierbas', 5600.00, 15),
		('Atún Sellado', 13, 'Atún a la plancha con salsa cítrica', 5300.00, 5),
		('Trucha a las Finas Hierbas', 13, 'Trucha con manteca y especias', 5300.00, 2),
		('Merluza a la Parrilla', 13, 'Filete de merluza grillado con limón', 4200.00, 11),
		...
		('Cornalitos', 14, 'Pescaditos fritos pequeños', 3700.00, 7),
		...
		('Paella', 15, 'Arroz con mariscos y azafrán', 6000.00, 2),
	...
	-- Categoría 7: Woks
		...
		('Wok con Pollo y Ananá', 17, 'Pollo salteado con piña y verduras', 3650.00, 16),
	...
	-- Categoría 8: Risottos
		...
		('Risotto de Langostinos', 20, 'Risotto con langostinos y azafrán', 5300.00, 15),
	...
	-- Categoría 9: Pizzas
		...
		('Jamón y Morrones', 21, 'Pizza con jamón y pimientos', 3200.00, 14),
		...
		('Pizza de Provolone', 22, 'Provolone fundido con orégano', 3500.00, 6),
	...
	-- Categoría 10: Postres
		...
		('Torta de Chocolate', 23, 'Torta húmeda de chocolate', 2300.00, 9),
		...
		('Helado Limón', 24, 'Helado refrescante de limón', 900.00, 6),
		...
		('Frutas Frescas', 25, 'Ensalada de frutas de estación', 1000.00, 9),
	...
	-- Categoría 11: Bebidas sin alcohol
		...
		('Agua Saborizada', 26, 'Agua con sabor a limón o durazno', 700.00, 13),

		-- Subcategoría 27: Gaseosas
		('Coca-Cola', 27, 'Gaseosa clásica 500ml', 800.00, 9),
		('Sprite', 27, 'Gaseosa limón 500ml', 800.00, 0),
		('Fanta', 27, 'Gaseosa naranja 500ml', 800.00, 15),
		('Pepsi', 27, 'Gaseosa cola 500ml', 800.00, 6),
		('Seven Up', 27, 'Gaseosa limón 500ml', 800.00, 4),
	...
	-- Categoría 12: Bebidas con alcohol
		...
		('Cerveza IPA', 29, 'Cerveza IPA con notas cítricas', 1500.00, 14),
		...
		-- Subcategoría 31: Tragos
		('Fernet con Coca', 31, 'Clásico trago argentino con cola', 1800.00, 2),
		('Caipirinha', 31, 'Cachaça, lima y azúcar sobre hielo', 2000.00, 9),
		('Mojito', 31, 'Ron, menta, lima, azúcar y soda', 2100.00, 0),
		('Cuba Libre', 31, 'Ron con cola y limón', 1900.00, 6),
		('Gin Tonic', 31, 'Gin con tónica y rodajas de pepino o limón', 2200.00, 13),
		('Campari con Naranja', 31, 'Bitter Campari con jugo de naranja natural', 2000.00, 1),

	-- Categoría 31: Cafetería
		-- Subcategoría 32: Cafés
		('Café Solo', 32, 'Café negro servido en taza pequeña', 800.00, 8),
		('Café con Leche', 32, 'Café con leche caliente espumosa', 1000.00, 5),
		('Café Cortado', 32, 'Café negro con un toque de leche', 850.00, 14),
		('Café Doble', 32, 'Doble carga de café para más intensidad', 900.00, 11),

		-- Subcategoría 33: Tés
		('Té Negro', 33, 'Infusión clásica con saquito', 700.00, 3),
		('Té Verde', 33, 'Té con propiedades antioxidantes', 750.00, 10),
		('Té de Hierbas', 33, 'Mezcla de hierbas naturales', 700.00, 12),
		('Té Frutado', 33, 'Infusión con sabor a frutos rojos', 750.00, 15),

		-- Subcategoría 34: Especiales
		('Capuccino', 34, 'Café con leche espumosa y cacao', 1200.00, 17),
