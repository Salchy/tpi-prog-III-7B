...
INSERT INTO Menu(Nombre_Menu, idSubCategoria, Descripcion, Precio) VALUES
	...
	-- Categoría 12: Bebidas con alcohol
		...
		('Fernet con Coca', 31, 'Clásico trago argentino con cola', 1800.00),
		('Caipirinha', 31, 'Cachaça, lima y azúcar sobre hielo', 2000.00),
		('Mojito', 31, 'Ron, menta, lima, azúcar y soda', 2100.00),
		('Cuba Libre', 31, 'Ron con cola y limón', 1900.00),
		('Gin Tonic', 31, 'Gin con tónica y rodajas de pepino o limón', 2200.00),
		('Campari con Naranja', 31, 'Bitter Campari con jugo de naranja natural', 2000.00),

	-- Categoría 31: Cafetería
		-- Subcategoría 32: Cafés
		('Café Solo', 32, 'Café negro servido en taza pequeña', 800.00),
		('Café con Leche', 32, 'Café con leche caliente espumosa', 1000.00),
		('Café Cortado', 32, 'Café negro con un toque de leche', 850.00),
		('Café Doble', 32, 'Doble carga de café para más intensidad', 900.00),

		-- Subcategoría 33: Tés
		('Té Negro', 33, 'Infusión clásica con saquito', 700.00),
		('Té Verde', 33, 'Té con propiedades antioxidantes', 750.00),
		('Té de Hierbas', 33, 'Mezcla de hierbas naturales', 700.00),
		('Té Frutado', 33, 'Infusión con sabor a frutos rojos', 750.00),

		-- Subcategoría 34: Especiales
		('Capuccino', 34, 'Café con leche espumosa y cacao', 1200.00),
